...
export default function Home() {
  return (
    <main className="flex w-full flex-col items-center justify-between py-8 px-8 bg-white dark:bg-gray-800">
      <section className="mx-auto px-4 py-12 sm:px-6 flex flex-col md:flex-row items-start gap-8">
        <div className="flex-1 text-left">
          <p className="text-2xl mb-4 text-black dark:text-zinc-50">
        ...
        <div className="flex flex-col items-end">
          <Image
            ...
            priority
          />
          <p className="w-full text-black dark:text-zinc-50 text-left md:text-left max-w-sm">
